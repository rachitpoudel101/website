      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div class="order-1 lg:order-2">
          <h2 class="text-3xl font-bold text-gray-900 mb-8">
            FAQs – Study in Australia for Indian Students
          </h2>
          ...
          <div class="space-y-5">
            ...
            <div>
              ...
              <p class="text-gray-700 text-base leading-relaxed font-sans">
                ...
                <span class="font-semibold"
                  >eCoE (Electronic Confirmation of Enrolment)</span
                >. Student visa (Subclass 500) under SSVF allows study and
                part-time work.
              </p>
            </div>
            ...
            <div>
              ...
              <p class="text-gray-700 text-base leading-relaxed font-sans">
                ...
                work experience, skilled migration visas allow applying for PR.
              </p>
            </div>

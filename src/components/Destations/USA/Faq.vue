    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div class="order-2 lg:order-1 flex items-center justify-center">
          <img
            :src="bgImage"
            alt="Students Graduation in USA"
            ...
            <div>
              ...
              <p class="text-gray-700 text-base leading-relaxed font-sans">
                ...
                <span class="font-semibold"
                  >OPT (Optional Practical Training)</span
                >
                after graduation and later apply for H-1B or other work visas,
                which may lead to permanent residency.
              </p>
            </div>

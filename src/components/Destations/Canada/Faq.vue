      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div class="order-2 lg:order-1 flex items-center justify-center">
          <img
            ...
            class="rounded-lg shadow-lg w-full h-auto object-cover min-h-[705px]"
          />
        </div>
        ...
        <div class="order-1 lg:order-2">
          ...
          <div class="space-y-5">
            ...
            <div>
              <h3
                class="text-lg font-semibold text-gray-900 mb-3 font-sans text-lg"
              >
                Q1. What is the cost of studying in Canada for Indian students?
              </h3>
              <p
                class="text-gray-700 text-base leading-relaxed font-sans text-lg"
              >
